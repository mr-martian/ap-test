...
RUN apt-get -qfy install --no-install-recommends automake autotools-dev build-essential cmake curl git flex libicu-dev libtool libutfcpp-dev libxml2-dev libxml2-utils pkg-config python3-dev python3-lxml python3-setuptools swig unzip wget xsltproc zip zipcmp
